;(function () {
     ...
     */
    ////必填////
    easemobIM.config.tenantId = setDefault(easemobIM.config.tenantId || '');//租户id
    ...
    easemobIM.config.URL = setDefault(easemobIM.config.URL, 'im-api.easemob.com');//环信聊天服务器地址
    ...
    easemobIM.config.visitorSatisfactionEvaluate = setDefault(easemobIM.config.visitorSatisfactionEvaluate, false);//是否允许访客主动发起满意度评价
    ...
    link.href = easemobIM.config.staticPath + '/css/im.css';
    ...
    document.getElementById('EasemobKefuWebimIframe').onload = function () {
        ...
        var loadIm = function () {
            ...
            script.src = easemobIM.config.staticPath + '/js/im.js';
